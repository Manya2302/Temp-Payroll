...
export default function AddEmployee() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50" data-testid="add-employee-page">
      ...
      <div className="flex-1 ml-64">
        ...
        <main className="p-6">
          <div className="max-w-2xl">
            <Card data-testid="card-add-employee-form">
              <CardHeader>
                <CardTitle data-testid="text-form-title">Employee Information</CardTitle>
              </CardHeader>
              <CardContent>
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6" data-testid="form-add-employee">
